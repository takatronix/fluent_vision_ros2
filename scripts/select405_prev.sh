...
# =============================================================================
# Fluent Vision - D405アスパラガス解析「前へ」選択コマンド
# =============================================================================
# 
# 概要：
#   - D405アスパラガス解析ノードに「前のアスパラガス」選択メッセージを送信
#   - キーボードショートカットとして使用可能
#   - リアルタイムでのアスパラガス選択制御
#
# 使用方法：
...
# ヘルプ表示
show_help() {
    echo "Fluent Vision D405アスパラガス解析「前へ」選択コマンド"
    echo ""
    echo "使用方法:"
    echo "  $0"
    echo ""
    echo "機能:"
    echo "  D405アスパラガス解析ノードに「前のアスパラガス」選択メッセージを送信"
    echo ""
    echo "例:"
    echo "  $0     # D405の前のアスパラガスを選択"
}
